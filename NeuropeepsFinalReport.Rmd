...
interact.aro = summary(aov(data= color_data_pr, Pic_arousal_MEAN ~ pic * color))
...
interact.val = summary(aov(data= color_data_pr, Pic_valence_MEAN ~ pic * color))
...
anova(red$Pic_arousal_MEAN, blue$Pic_arousal_MEAN)


summary(aov(data= color_data_pr, Pic_arousal_MEAN ~ color*pic))
#recreate their scheffe

PostHocTest(x=col.con.anov, method="scheffe")
