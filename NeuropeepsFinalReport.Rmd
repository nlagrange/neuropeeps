...
There was also an effect of __context__ on mean arousal ratings __(F(1,301) = 115.01, p < .001)__. This is somewhat elided in the article's discussion of results, which renders the main finding of the paper confusing. 
```{r, test/neu plot}
